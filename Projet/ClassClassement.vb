...
Public Class Classement_Modules
    ...
    Public Function Trait_Classement() As DataTable
        ...
        Dim finale As New DataTable ' Datatable finale 
        Classes.Columns.Add("Rang", GetType(String))
        finale.Columns.Add("Rang", GetType(String))
        Classes.Columns.Add("Matricule", GetType(String))
        finale.Columns.Add("Matricule", GetType(String))
        Classes.Columns.Add("Nom", GetType(String))
        finale.Columns.Add("Nom", GetType(String))
        Classes.Columns.Add("Prénoms", GetType(String))
        finale.Columns.Add("Prénoms", GetType(String))
        Classes.Columns.Add("Option", GetType(String))
        finale.Columns.Add("Option", GetType(String))
        Classes.Columns.Add("1ère Juin", GetType(String))
        finale.Columns.Add("1ère Juin", GetType(String))
        Classes.Columns.Add("1ère Sept", GetType(String))
        finale.Columns.Add("1ère Sept", GetType(String))
        Classes.Columns.Add("2ème Juin", GetType(String))
        finale.Columns.Add("2ème Juin", GetType(String))
        Classes.Columns.Add("2ème Sept", GetType(String))
        finale.Columns.Add("2ème Sept", GetType(String))
        Classes.Columns.Add("3ème Juin", GetType(String))
        finale.Columns.Add("3ème Juin", GetType(String))
        Classes.Columns.Add("3ème Sept", GetType(String))
        finale.Columns.Add("3ème Sept", GetType(String))
        Classes.Columns.Add("4ème Juin", GetType(String))
        finale.Columns.Add("4ème Juin", GetType(String))
        Classes.Columns.Add("4ème Sept", GetType(String))
        finale.Columns.Add("4ème Sept", GetType(String))
        Classes.Columns.Add("5ème Juin", GetType(String))
        finale.Columns.Add("5ème Juin", GetType(String))
        Classes.Columns.Add("5ème Sept", GetType(String))
        finale.Columns.Add("5ème Sept", GetType(String))
        Classes.Columns.Add("Moyenne Générale", GetType(Double))
        finale.Columns.Add("Moyenne Générale", GetType(Double))
        ...
        '  finale = Classes.DefaultView.ToTable
        Dim dt As DataTable
        dt = Classes.DefaultView.ToTable

        Dim nb As Integer = 0 ' nombre d'etudiants a classer, choisi dans la page de classement

        If (Classement.nbBox.Value = 0) Or (Classement.nbBox.Value > Classes.DefaultView.ToTable.Rows.Count) Then
        ...
        Else
            For Each r As DataRow In dt.Rows
                ...
                finale.ImportRow(r)
                nb = nb + 1
                If nb = Classement.nbBox.Value Then
                    Exit For
                End If
            Next
            Return finale
    ...
    Public Sub affichageClassement()
        ...
        If dt Is Nothing Then
            ...
            Classement.ImpBut.Visible = False
            Exit Sub
        End If

        Classement.ImpBut.Visible = True
        ...
        Next
        Dim an As New DataTable
        For Each dr As DataRow In Grp.Rows
            dr.Item("AnneeScolaire") = Classement.anesBox.SelectedItem

            If dr.Item("Option").ToString = "SI" Then
                dr.Item("Option") = "Système d'Information"
            End If
            If dr.Item("Option").ToString = "SIQ" Then
                dr.Item("Option") = "System d'informatiques"""
            End If
        ...
        End With
        For Each dgr As DataGridViewRow In dgv.Rows
            an.Rows.Add(dgr.Cells(4).Value)
        Next
        For Each dr As DataRow In an.Rows
        ...
        Rpt.Database.Tables("Note").SetDataSource(an)
        Impression.CrystalReportViewer1.ReportSource = Rpt
        Impression.CrystalReportViewer1.Refresh()
