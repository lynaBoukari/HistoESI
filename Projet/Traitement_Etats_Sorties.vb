...
Public Class Traitement_Etats_Sorties
...
#Region "Traitement Releve de note global "
    Public Sub ReleveGlobal(ByVal Matricule As String)
        ...
        Else
            ' Ets.DataGridView1.DataSource = AccessNote.DBDT , On ytilise cette methode si la table obtenu d'aprés PARCOURS ne contient pas 2 lignes (etudiant pas admis , selon la cmd sql ) , alors an laisse la table vide 
